         ...
         <div class="col-md-10">
            <div class="box">
               ...
               <div class="box-body table-responsive">
                  <table class="table table-striped table-hover table-bordered border-primary" id="timetable1">
                        ...
                        <tr id="<?php echo $s_time; ?>_<?php echo $e_time; ?>">
                           ...
                           <td>
                              <?php 
                                 ...
                                 $sql="select timetable.id as tt_id,subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name,timetable.meeting_link as t_link
                                       from timetable
                                       inner join subject
							  ...
							  <hr/>
                              <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['tt_id']; ?>,<?php echo $index; ?>" data-toggle="modal">Edit</a><!--MSK-00131-Sunday-->  
