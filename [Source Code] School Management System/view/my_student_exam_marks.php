               ...
               <div class="box-body">
                  <div class="form-group" id="divGrade">
                     ...
                     <div class="col-md-7" id="divGrade1">
                        <select name="grade" class="form-control" id="grade" style="width:105%;" >
                           <!--MSK-000107-->
                  ...
                  <div class="form-group" id="divExam">
                     ...
                     <div class="col-md-7" id="divExam1">
                        <select name="exam" class="form-control" id="exam" style="width:105%;" >
                           <!--MSK-000107-->
...
<script>
 console.log('Pre Script Started');
      $(document).ready(function(){
         console.log('Script Started');// body: to attach event on dynamic elements
         $("body").on('click', '#upload-csv', function() {
            console.log('I am here');
      	  var grade = $('#grade').val();
		  var exam = $('#exam').val();
           console.log(grade);
            var fd = new FormData(); //javascript virtual form
            var files = $('#customFileInput')[0].files;
            console.log(files);
            // Check file selected or not
            if(files.length > 0 ) {
               fd.append('file',files[0]);
      		fd.append('grade', grade); //Inserting input field with value into virtual form
			  fd.append('exam', exam);
               $.ajax({
                  url: 'upload_exam_csv.php',
                  type: 'post',
                  data: fd,
                  contentType: false,
                  processData: false,
                  ...
                  error: function(err){
                     $('#upload-status').html("Database is down please try again later");
                  },
               });
            } else {
      		$('#upload-status').html('Please select a file');
            }
         });
      });
