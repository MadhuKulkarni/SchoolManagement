                        		...
                        		<div class="col-md-6">
                                	...
                                	<div class="form-group" id="divIndexNumber">
                                        ...
                                        <div class="col-xs-9" id="divFullName1">
                                           <input type="text" class="form-control" placeholder="Enter full name" name="full_name" id="full_name" autocomplete="off" value="">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divIName">
                                        ...
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control" placeholder="Enter name with initials" name="i_name" id="i_name" autocomplete="off" value="">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divAddress">
                                        ...
                                        <div class="col-xs-9" id="divAddress1">
                                           <input type="text" class="form-control" placeholder="Enter address" name="address" id="address" autocomplete="off" value=""> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divEmail">
                                        ...
                                        <div class="col-xs-9" id="divEmail1">
                                           <input type="text" class="form-control" placeholder="Enter email address" name="email" id="email" autocomplete="off" value=""> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <div class="col-xs-7" id="divPhone1">
                                                	<input type="text" class="form-control" id="phone" name="phone" data-inputmask='"mask": "(999) 999-9999"' data-mask value="">
                                                </div> 
                                        	</div>  
                                            <div class="form-group" >
                                                ...
                                                <div class="col-xs-7" id="divDOB1">
                                                	<input type="text" class="form-control" placeholder="yyyy-mm-dd" id="b_date" name="b_date" value="">
                                                </div> 
                                        	</div>  
                                            <div class="form-group" >
                                ...
                                <div class="col-md-6">
                                	...
                                	<div class="form-group" id="divGIndexNumber">
                                        ...
                                        <div class="col-xs-9" id="divGIndexNumber1">
                                           <input type="text" class="form-control" placeholder="Enter index number" name="g_index" id="g_index" autocomplete="off">  
                                        </div>                    
                                    </div>
                                     <div class="form-group" id="divGFullName">
                                        ...
                                        <div class="col-xs-9" id="divGFullName1">
                                           <input type="text" class="form-control" placeholder="Enter full name" name="g_full_name" id="g_full_name" autocomplete="off" value="">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control" placeholder="Enter name with initials" name="g_i_name" id="g_i_name" autocomplete="off" value="">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGAddress">
                                        ...
                                        <div class="col-xs-9" id="divGAddress1">
                                           <input type="text" class="form-control" placeholder="Enter address" name="g_address" id="g_address" autocomplete="off" value=""> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGEmail">
                                        ...
                                        <div class="col-xs-9" id="divGEmail1">
                                           <input type="text" class="form-control" placeholder="Enter email address" name="g_email" id="g_email" autocomplete="off" value=""> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                                            <div class="form-group" >
                                                ...
                                                <div class="col-xs-7" id="divGPhone1">
                                                	<input type="text" class="form-control" id="g_phone" name="g_phone" data-inputmask='"mask": "(999) 999-9999"' data-mask value="" >
                                                </div> 
                                        	</div>
                                            <div class="form-group" >
                                                ...
                                                <div class="col-xs-7" id="divGDOB1">
                                                	<input type="text" class="form-control" placeholder="yyyy-mm-dd" id="g_b_date" name="g_b_date" value="">
                                                </div> 
                                        	</div> 
                                            <div class="form-group" >
