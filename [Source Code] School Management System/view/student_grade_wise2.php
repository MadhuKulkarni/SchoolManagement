...
<div class="col-md-8">
   <div class="box">
      <div class="box-header">
         ...
         <button  class="btn btn-primary pull-right" data-toggle="modal" data-target="#attendance">Attendance</button>
      </div>
      <!-- /.box-header -->
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td id="td1_<?php
                     echo $row['std_id'];
                     ?>">
                     <a href="#modalviewform" onClick="showModal1(this)" class=""  data-id="<?php
                        echo $row["std_id"];
                        ?>,<?php
                        echo $grade_id;
                  ...
                  <td>
                     <!--MSK-00113 -->                                    
                     <a href="edit_student2.php?std_index=<?php
                        echo $row["std_index"];
                        ?>&grade_id=<?php
                        echo $grade_id;
                        ?>" onClick="" class="btn btn-info btn-xs">Edit</a>
                     <!--MSK-00128 -->
                     <a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php
                        echo $row["std_id"];
                        ?>,<?php
                        echo $grade_id;
                        ?>,<?php
                        ...
                        ?>">Leave</a>
                     <!--MSK-00146 -->
                     <a href="#" class="btn btn-success btn-xs" onClick="editSubject(this)"  data-id="<?php
                        echo $row["std_index"];
                        ?>" >Edit Subject</a>
                     <a href="#" class="confirm-upgrade btn btn-danger btn-xs"  data-id="<?php
                        echo $row["std_index"];
                        ?>" >Upgrade Grade</a>  
                  </td>
               </tr>
