...
<div class="content-wrapper">
   ...
   <div id="viewSubjectDiv2">
      <!--MSK-000126 me tika mokadda kiyala nawatha bala creative widiyta edit karanwa :D --> 
   </div>
   ...
   <div class="modal msk-fade" id="modalSelectGrade" tabindex="-1" role="dialog" aria-labelledby="modalSelectGrade" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog">
         <!--modal-dialog -->  
         <div class="container col-lg-6 msk-modal-content">
            <!--modal-content --> 
            <div class="row">
  ...
  $('body').on('click', '.submitToDB', function(e){
      ...
      $('#ex1 tr').each(function(i,row){
         if(!i==0){
            ...
            let studId = $(this).find('td:nth-child(1)').attr('data-studid');
            let subject = $(this).find('td:nth-child(2)').text();
            let date = $(this).find('td:nth-child(3)').text();
            let time = $(this).find('td:nth-child(4)').text();
            let attendance = ($(this).find('td:nth-child(5)').find('input[type="checkbox"]').is(':checked')) ? 'Present' : 'Absent';
            rowdata.push({studId:studId, subject:subject, date:date, time:time, attendance:attendance });
