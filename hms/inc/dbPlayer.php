...
class dbPlayer {
    ...
    private $db_name="hostel_management_system";
   ...
   public function open(){
    ...
    public  function  getData($query)
    {
        ...
        if(!$res)
        {   
            return (object)array("error"=>"Can't get data ".mysqli_error($this->con));
        }
        else
        {
            return $res;
    ...
    public function  update($query)
    {
        ...
        if(!$res)
        {
            return (object)array("error"=>"Can't update data ".mysqli_error($this->con));
        }
        else
        {
            return "true";
    ...
    public  function delete($query)
    {
       ...
       // var_dump($query);
        if(!$res)
        {
            return (object)array("error"=>"Can't delete data ".mysqli_error($this->con));
        }
        else
        {
            return "true";
    ...
    public  function execNonQuery($query)
    {
        ...
        if(!$res)
        {
            return (object)array("error"=>"Can't Execute Query ".mysqli_error($this->con));
        }
        else
        {
            return "true";
