...
else
{
    ...
    if (isset($_GET['id']) && $_GET['wtd']) {
        ...
        if($_GET['wtd']==="delete")
        {
            if ($msg = "true") {
                ...
                {
                    echo '<script type="text/javascript"> alert("' . $result->error . '");window.location.href = "list.php";</script>';
                }
            } else {
    ...
    elseif(isset($_GET['update']))
    {
        ...
        if ($msg = "true") {
            ...
            {
                echo '<script type="text/javascript"> alert("' . $result->error . '");window.location="list.php";</script>';
            }
        } else {
