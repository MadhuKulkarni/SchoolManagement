...
else
{
    ...
    if(isset($_GET['id']) && $_GET['wtd']==="delete")
    {
        if ($msg = "true") {
            ...
            {
                echo '<script type="text/javascript"> alert("' . $result->error . '");window.location.href = "approvallist.php";</script>';
            }
        } else {
...
{
    echo '<script type="text/javascript"> alert("' . $result->error . '");window.location="approvallist.php";</script>';
}
} else {
