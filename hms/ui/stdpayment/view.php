...
else
{
    ...
    if(isset($_GET['id']) && $_GET['wtd']==="delete")
    {
        if ($msg = "true") {
            ...
            {
                echo '<script type="text/javascript"> alert("' . $result->error . '");window.location.href = "view.php";</script>';
            }
        } else {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        elseif (isset($_POST["btnUpdatePay"])) {
            ...
            if ($msg = "true") {
                ...
                echo '<script type="text/javascript"> alert("' . $result->error . '");window.location="view.php";</script>';
                }
                $ses->remove("serial");
